...
CURRENCY_BREAKCOIN = "🪙"
CURRENCY_BREAKCOIN_NAME = "BreakCoin"
CURRENCY_SHARD = "🧩"
CURRENCY_SHARD_NAME = "Fragmento de BreakCoin"
EMBED_COLOR = 0xE05C8A
EMBED_COLOR_ERROR = 0xB03A3A
EMBED_COLOR_SUCCESS = 0x4E9A5B

# BreakCoin Shard & Pity rules
SHARDS_PER_BREAKCOIN = 4
SHARD_BASE_CHANCE_PERCENT = 2.0
SHARD_PITY_THRESHOLD_DAYS = 15
SHARD_PITY_INCREMENT_PERCENT = 3.0
